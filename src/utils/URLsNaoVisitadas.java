...
public class URLsNaoVisitadas {
	...
	private String DBName = "urlsNaoVisitadasDatabase";
	private String CollectionName = "urlsNaoVisitadas";
	...
	public static void main(String[] args) throws UnknownHostException, URISyntaxException{
		...
		URLsNaoVisitadas url = new URLsNaoVisitadas();

		//url.deleteCollection();
		url.insert("www.google.com");
		url.insert("teste.com");
		url.printCollection();
